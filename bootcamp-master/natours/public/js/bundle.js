...
var displayMap = exports.displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1Ijoiam9zZWx1aXNlc3Bpcml0dSIsImEiOiJjbG45cXVkdXUwODZyMnRzZWFpNHc5aTB5In0.5cdRFziG3sRNvQC2vo8GfQ';
  var map = new mapboxgl.Map({
    container: 'map',
    // container ID
    style: 'mapbox://styles/joseluisespiritu/clnkcrzvf000501qj9adteufu',
    // style URL
    scrollZoom: false
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        ...
        case 7:
          ...
          (0, _alerts.showAlert)('error', 'Error login out! Try again.');
        case 11:
        case "end":
